    ...
    public partial class CreateUpdateForm : Form
    {
        ...
        private void IncarcaEdituri()
        {
            try
            {
                ...
                DataTable edituri = data.GetEdituri();
        ...
        private void IncarcaAutori()
        {
            ...
            {
                var data = new CarteDataSet();
                DataTable autori = data.GetAutori();
        ...
        public Carte GetCarteModificata()
        {
            ...
            if (int.TryParse(this.tbAnPublicare.Text, out int anPublicare))
                ...
                MessageBox.Show("Anul publicării trebuie să fie între 1445 și 2025!");
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (!int.TryParse(this.tbAnPublicare.Text, out int anPublicare) || anPublicare < 1445 || anPublicare > 2025)
            {
                MessageBox.Show("Anul publicării trebuie să fie între 1445 și 2025!");
                this.tbAnPublicare.Focus();
                return;
            ...
            var data = new CarteDataSet();
            if (carte.Id == 0)
                data.CreateCarte(carte);
            else
                data.UpdateCarte(carte);
